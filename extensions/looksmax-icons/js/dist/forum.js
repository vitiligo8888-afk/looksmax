...
(function () {
  ...
  var MAP = {
    ...
    'fa-comment': 'ph:chat-circle-fill', 'fa-dumbbell': 'material-symbols:exercise-rounded',
    'fa-heart-pulse': 'material-symbols:ecg-heart-rounded', 'fa-sack-dollar': 'material-symbols:payments-rounded',
